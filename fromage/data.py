...
def get_dataset(args, split: str, tokenizer) -> Dataset:
    ...
    def __getitem__(self, idx):
        while True:
            ...
            try:
                ...
                cap_img = utils.create_image_of_text(decode_caption.encode('ascii', 'ignore'), width=self.image_size,
                                                     nrows=2, font=self.font)
